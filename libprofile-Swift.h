...
// Generated by Apple Swift version 5.4.2 (swiftlang-1205.0.28.2
// clang-1205.0.19.57)
...
- (void)contactPhotoWithRequest:(NCNotificationRequest *_Nonnull)request
                           with:(NSString *_Nonnull)header
                           with:(NSString *_Nonnull)body
                       callback:(void (^_Nonnull)(UIImage *_Nonnull))callback;
@end
